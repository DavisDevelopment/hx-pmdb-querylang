...
abstract SqlStatement (ESqlStatement) from ESqlStatement to ESqlStatement {
    ...
    @:from public static inline function Update(stmt: UpdateStatement):SqlStatement {
        return Dml(UpdateStatement(stmt));
    }
    @:from public static inline function Insert(stmt: InsertStatement):SqlStatement {return Dml(InsertStatement(stmt));}
...
enum DmlStatement {
    ...
    // InsertStatement;
    // ...etc
    UpdateStatement(stmt: UpdateStatement);
...
class UpdateStatement extends SqlAstNode {
    public var target: SqlSymbol;
    public var operations: Array<UpdateOp>;
    public var where: Null<Predicate> = null;
...
class InsertStatement extends SqlAstNode {
    public var target: ql.sql.grammar.CommonTypes.TablePath;
    public var columns: Null<Array<String>> = null;
    public var values: Array<Array<Expression>>;
