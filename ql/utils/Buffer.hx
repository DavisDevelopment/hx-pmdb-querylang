...
class Statics {
    public static function alloc(size:Int, fill:Mixed3<Int, String, UInt8Array>, ?encoding:Encoding):Buffer {
        throw new pm.Error.NotImplementedError();
    }
    public static inline function byteLength(b:Buffer):Int {
        return b.get_byteLength();
    }
    /**
	...
	**/
	public static function compareBuffers(a:Buffer, b:Buffer):Int {
        return Reflect.compare(a.get_length(), b.get_length());
    }
	/**
	...
	**/
    public static function concat(list:Array<Buffer>, ?totalLength:Int):Buffer {
        throw new pm.Error.NotImplementedError();
    }
	/**
    ...
    **/
    public static function from(value:Dynamic, ?offset:Int, ?encoding:Encoding, ?length:Int):Buffer {
        //
    }
    public static function fromUInt8Array(array:UInt8Array):Buffer {throw new pm.Error.NotImplementedError();}
    public static function fromBuffer(buffer:Buffer):Buffer {throw new pm.Error.NotImplementedError();}
    public static function fromIntArray(array: Array<Int>):Buffer {throw new pm.Error.NotImplementedError();}
    public static function fromString(s:String, ?encoding:Encoding, ?offset:Int, ?length:Int):Buffer {throw new pm.Error.NotImplementedError();}
}

interface Buffer {
    function get_length():Int;
    function get_byteLength():Int;
    // function get_view():ArrayBufferView;//?
    function sub(begin:Int, ?length:Int):Buffer;
    function subarray(?begin:Int, ?end:Int):Buffer;
	...
	**/
    function lastIndexOfByte(value:Int, ?byteOffset:Int):Int;
    function lastIndexOfUI8(value:UInt8Array, ?byteOffset:Int):Int;
    function lastIndexOfBuffer(value:Buffer, ?byteOffset:Int):Int;
    function lastIndexOfString(value:String, ?byteOffset:Int, ?encoding:Encoding):Int;
    function lastIndexOf(value:Mixed4<Int,String,Buffer,UInt8Array>, ?byteOffset:Int, ?encoding:Encoding):Int;
